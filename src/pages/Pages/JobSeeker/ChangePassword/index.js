...
<Label htmlFor="employeeName" className="form-label " style={{fontSize: '0.8rem'}}>Currnet Password</Label>
    <Input type="password" className="form-control p-3" id="employeeName" placeholder="Currnet Password"/>
</div>
<div className="mb-3 col-xl-5">
    <Label htmlFor="employeeUrl" className="form-label" style={{fontSize: '0.8rem'}}>New Password</Label>
    <Input type="password" className="form-control p-3" id="employeeUrl" placeholder="New Password"/>
</div>
<div className="mb-3 col-xl-5">
    <Label htmlFor="StartleaveDate" className="form-label" style={{fontSize: '0.8rem'}}>Confirm New password</Label>
    <Input type="password" className="form-control p-3" id="employeeUrl" placeholder="Confirm New Password"/>
</div>


<div className="text-end mt-4">
    <button type="submit" className="btn p-3" style={{

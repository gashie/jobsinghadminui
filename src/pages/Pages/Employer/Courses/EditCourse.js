import {
  ...
  import { saveCourse, updateCourse } from "../../../../store/actions";
  import { useNavigate } from "react-router-dom";
  
  const EditCourse = ({data, handleEditModal}) => {
    ...
    const validation = useFormik({
      ...
      initialValues: {
        ...
        organizer: data?.courseOrganizer || "",
      ...
      onSubmit: (values) => {
        const patch = {
          ...
          courseOrganiser: values.Organiser,
          courseVenue: values.courseVenue,
          courseCost: values.courseCost,
          ...
          courseGoals: values.coursegoals,
          courseLink: values.courseLink,
          courseCertificationNote: values.courseCertificationNote,
        };
        ...
        patchData.append("deleterecord", true);

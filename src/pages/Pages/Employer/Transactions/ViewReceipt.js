    ...
    <>
      ...
      {Object.keys(data).length > 0 ? (
        <div className="px-4 mx-1">
          ...
          >
            <div className="mt-5">
              <p style={{ fontWeight: "bolder" }}>{userInfo?.userInfo?.company?.companyName}</p>
              <p>{userInfo?.userInfo?.company?.location}</p>
              {/* <p>334 Silver Lane,</p> */}
              <p>Ghana.</p>
            </div>
            ...
            <div>
              ...
              <p style={{ textAlign: "right" }}>
                {data.counter === null ? "" : data?.counter}
              </p>
        ...
        <p className="d-flex hstack justify-content-center">
          Please select a reciept from the transactions tab to view its contents
        </p>
      )}
    </>
  );

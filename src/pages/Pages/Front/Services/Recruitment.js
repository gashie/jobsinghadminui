            ...
            <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
              ...
              <Col xs={10} xl={6} md={6}>
                ...
                <p className="fs-16">
                  ...
                  searching in our extensive databases, networking, headhunting
                  and proactively contacting and recruiting potential
                  candidates. Based on our knowledge of your organization and
                ...
                <Col xl={5}>
                  <div style={{ display: "grid", gap: "1rem" }}>
                    ...
                    <p className="fs-15" style={{ textAlign: "center" }}>
                      Select multiple candidates to create a talent pool and
                      only interact with the candidates that best fit your
                      requirements
                    </p>
                  </div>
                  <div
